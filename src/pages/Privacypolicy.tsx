    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Das Datenschutzerklärung der Waldschnecken"
                />
            </Helmet>

            <MainLayout pagetitle="Datenschutz&shy;erklärung">
                <section className="col-start-2 col-end-4">
                    <p>Stand: 2. September 2023</p>
                    ...
                    <h2 className="mb-2 text-2xl font-bold" id="m3">
                        Verantwortlicher
                    </h2>
                    <p>
                        Tatjana Nabrotzky und Oksana Welk, Auf Stieneckers 52,
                        49549 Ladbergen
                    </p>
                    E-Mail-Adresse: <p>kontakt@waldschnecken-ladbergen.de</p>
                    Impressum: <p>waldschnecken-ladbergen.de/imprint/</p>
                    <br />
                    <h2 className="my-2 text-2xl font-bold" id="m2427">
                        Maßgebliche Rechtsgrundlagen
                    </h2>
                    <p>
                        <strong>
                            Maßgebliche Rechtsgrundlagen nach der DSGVO: <br />
                        </strong>
                    ...
                    <p>
                        ...
                        „Bearbeitung“ von „Personendaten“, &ldquo;überwiegendes
                        Interesse&rdquo; und &ldquo;besonders schützenswerte
                        Personendaten&rdquo; werden die in der DSGVO verwendeten
                        Begriffe &ldquo;Verarbeitung“ von
                        &ldquo;personenbezogenen Daten&rdquo; sowie
                        &ldquo;berechtigtes Interesse&rdquo; und
                        &ldquo;besondere Kategorien von Daten&rdquo; verwendet.
                        Die gesetzliche Bedeutung der Begriffe wird jedoch im
                        Rahmen der Geltung des Schweizer DSG weiterhin nach dem
                        Schweizer DSG bestimmt.
                    </p>
                    <h2 className="my-2 text-2xl font-bold" id="mOverview">
                        Übersicht der Verarbeitungen
                    </h2>
                    <p>
                    ...
                    <h2 className="my-2 text-2xl font-bold" id="m27">
                        Sicherheitsmaßnahmen
                    </h2>
                    <p>
                    ...
                    <h2 className="my-2 text-2xl font-bold" id="m24">
                        Internationale Datentransfers
                    </h2>
                    <p>
                        ...
                        dem Drittland mit, wobei die Angemesenheitsbeschlüsse
                    ...
                    <h2 className="my-2 text-2xl font-bold" id="m10">
                        Rechte der betroffenen Personen
                    </h2>
                    <p>
                    ...
                    <h2 className="my-2 text-2xl font-bold" id="m225">
                    ...
                    <ul className="m-elements">
                        <li>
                            ...
                            so genannten &ldquo;Server-Logfiles&rdquo;
                        ...
                        <li>
                            <strong>E-Mail-Versand und -Hosting: </strong>Die
                            von uns in Anspruch genommenen Webhosting-Leistungen
                            umfassen ebenfalls den Versand, den Empfang sowie
                            die Speicherung von E-Mails. Zu diesen Zwecken
                            werden die Adressen der Empfänger sowie Absender als
                            auch weitere Informationen betreffend den
                            E-Mailversand (z.B. die beteiligten Provider) sowie
                            die Inhalte der jeweiligen E-Mails verarbeitet. Die
                            vorgenannten Daten können ferner zu Zwecken der
                            Erkennung von SPAM verarbeitet werden. Wir bitten
                            darum, zu beachten, dass E-Mails im Internet
                            grundsätzlich nicht verschlüsselt versendet werden.
                            Im Regelfall werden E-Mails zwar auf dem
                            Transportweg verschlüsselt, aber (sofern kein
                            sogenanntes Ende-zu-Ende-Verschlüsselungsverfahren
                            eingesetzt wird) nicht auf den Servern, von denen
                            sie abgesendet und empfangen werden. Wir können
                            daher für den Übertragungsweg der E-Mails zwischen
                            dem Absender und dem Empfang auf unserem Server
                    ...
                    <h2 className="my-2 text-2xl font-bold" id="m391">
                        Kommunikation via Messenger
                    </h2>
                    <p>
                        Wir setzen zu Zwecken der Kommunikation Messenger ein
                        und bitten daher darum, die nachfolgenden Hinweise zur
                        Funktionsfähigkeit der Messenger, zur Verschlüsselung,
                        zur Nutzung der Metadaten der Kommunikation und zu Ihren
                        Widerspruchsmöglichkeiten zu beachten.
                    </p>
                    <p>
                        Sie können uns auch auf alternativen Wegen, z.B. via
                        Telefon oder E-Mail, kontaktieren. Bitte nutzen Sie die
                        Ihnen mitgeteilten Kontaktmöglichkeiten oder die
                        innerhalb unseres Onlineangebotes angegebenen
                        Kontaktmöglichkeiten.
                    </p>
                    <p>
                        Im Fall einer Ende-zu-Ende-Verschlüsselung von Inhalten
                        (d.h., der Inhalt Ihrer Nachricht und Anhänge) weisen
                        wir darauf hin, dass die Kommunikationsinhalte (d.h.,
                        der Inhalt der Nachricht und angehängte Bilder) von Ende
                        zu Ende verschlüsselt werden. Das bedeutet, dass der
                        Inhalt der Nachrichten nicht einsehbar ist, nicht einmal
                        durch die Messenger-Anbieter selbst. Sie sollten immer
                    ...
                    <p>
                        ...
                        zusätzlich darauf hin, dass die Anbieter der Messenger
                        zwar nicht den Inhalt einsehen, aber in Erfahrung
                        bringen können, dass und wann Kommunikationspartner mit
                        uns kommunizieren sowie technische Informationen zum
                        verwendeten Gerät der Kommunikationspartner und je nach
                        Einstellungen ihres Gerätes auch Standortinformationen
                        (sogenannte Metadaten) verarbeitet werden.
                    </p>
                    <p>
                        <strong>Hinweise zu Rechtsgrundlagen: </strong> Sofern
                        wir Kommunikationspartner vor der Kommunikation mit
                        ihnen via Messenger um eine Erlaubnis bitten, ist die
                        Rechtsgrundlage unserer Verarbeitung ihrer Daten deren
                        Einwilligung. Im Übrigen, falls wir nicht um eine
                        Einwilligung bitten und sie z.B. von sich aus Kontakt
                        mit uns aufnehmen, nutzen wir Messenger im Verhältnis zu
                        unseren Vertragspartnern sowie im Rahmen der
                        Vertragsanbahnung als eine vertragliche Maßnahme und im
                        Fall anderer Interessenten und Kommunikationspartner auf
                        Grundlage unserer berechtigten Interessen an einer
                        schnellen und effizienten Kommunikation und Erfüllung
                        der Bedürfnisse unser Kommunikationspartner an der
                        Kommunikation via Messenger. Ferner weisen wir Sie
                        darauf hin, dass wir die uns mitgeteilten Kontaktdaten
                        ohne Ihre Einwilligung nicht erstmalig an die Messenger
                        übermitteln.
                    </p>
                    <p>
                        <strong>Widerruf, Widerspruch und Löschung:</strong> Sie
                        können jederzeit eine erteilte Einwilligung widerrufen
                    </p>
                    <ul className="m-elements">
                        <li>
                            <strong>Verarbeitete Datenarten:</strong>{" "}
                            ...
                            Nutzungsdaten (z.B. besuchte Webseiten, Interesse an
                            Inhalten. Meta-, Kommunikations- und Verfahrensdaten
                        ...
                        <li>
                            <strong>Zwecke der Verarbeitung:</strong>{" "}
                            Kontaktanfragen und Kommunikation. Direktmarketing
                            (z.B. per E-Mail oder postalisch).
                        </li>
                        <li className="">
                            <strong>Rechtsgrundlagen:</strong> Einwilligung
                            (Art. 6 Abs. 1 S. 1 lit. a) DSGVO). Berechtigte
                            Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
                        </li>
                    </ul>
                    <h2 className="my-2 text-2xl font-bold" id="m136">
                        Präsenzen in sozialen Netzwerken (Social Media)
                    </h2>
                    <p>
                    ...
                    <ul className="m-elements">
                        <li>
                            ...
                            Ireland Limited, 4 Grand Canal Square, Grand Canal
